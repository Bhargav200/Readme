...
const portraitFilter = [
  "scale=1900:1900:force_original_aspect_ratio=increase,crop=1500:1500",
  "format=gray",
...
function buildProfileLines(projects) {
  return [
    { type: "header", value: "bhargav@aiml" },
    { type: "row", key: "Name", value: "A P Bhargav Ravi Teja" },
    { type: "row", key: "Role", value: "AI/ML Engineer" },
    { type: "row", key: "Based", value: "Secunderabad, India" },
    { type: "row", key: "Mode", value: "Learning / Building / Shipping" },
    { type: "blank" },
    { type: "section", value: "BUILD.FOCUS" },
    { type: "row", key: "AI/ML", value: "RAG, LLMs, and evaluation" },
    { type: "row", key: "ML", value: "TensorFlow and Scikit-learn" },
    { type: "row", key: "Backend", value: "FastAPI and Express.js" },
    { type: "row", key: "Core", value: "Data and algorithms" },
    { type: "blank" },
...
<title id="title">A P Bhargav Ravi Teja - AI/ML Engineer</title>
<desc id="description">An AI/ML engineer profile card with Bhargav's high-contrast ASCII portrait, technical focus, and selected work.</desc>
<defs>
...
<text x="${titleCenter}" y="${titlebar.y + titlebar.height / 2 + 5}" text-anchor="middle" class="terminal-label">bhargav@aiml ~ % ./profile</text>
...
<text x="${layout.visualTitle.x}" y="${layout.visualTitle.y}" class="panel-title">PORTRAIT / BHARGAV</text>
<text x="${layout.infoTitle.x}" y="${layout.infoTitle.y}" class="panel-title">PROFILE / AI-ML</text>
${ambientPortrait}
...
${system}
<text x="${layout.width / 2}" y="${layout.footerY}" text-anchor="middle" class="mono" font-size="10" letter-spacing="1.5" fill="${colors.muted}">AI/ML / GENERATIVE AI / FULL-STACK / DATA SYSTEMS</text>
